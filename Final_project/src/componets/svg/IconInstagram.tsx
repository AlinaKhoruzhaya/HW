...
export const IconInstagram = ({ id }: Props) => {
    switch (id) {
        case 'instagram':
            return (
                <svg className="instagram" fill="#c7c7c7" height="20px" width="20px" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink"
                    viewBox="0 0 24 24" space="preserve">
                    <g id="social-instagram">
                        <path id='instagram' d="M23.9,7.1c-0.1-1.3-0.3-2.1-0.6-2.9C23.1,3.4,22.7,2.7,22,2s-1.3-1.1-2.1-1.4c-0.8-0.3-1.6-0.5-2.9-0.6C15.7,0,15.3,0,12,0
		...
		c0.2,0.4,0.4,1.1,0.4,2.2c0.1,1.3,0.1,1.6,0.1,4.8S21.8,15.6,21.8,16.8z"/>
                        <path id='instagram' d="M12,6c-3.3,0-6,2.7-6,6s2.7,6,6,6s6-2.7,6-6S15.3,6,12,6z M12,15.9c-2.2,0-3.9-1.7-3.9-3.9S9.8,8.1,12,8.1s3.9,1.7,3.9,3.9
		S14.2,15.9,12,15.9z"/>
                        <circle id='instagram' cx="18.5" cy="6" r="1.5" />
                    </g>
                </svg>
            );
        default:
