...
export const IconApple = ({ id }: Props) => {
    switch (id) {
        case 'apple':
            return (
                <svg fill="#c7c7c7" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="20px"
                    height="20px" viewBox="0 0 512 512" space="preserve">
